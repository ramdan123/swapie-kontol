...
export default function Swap() {
  ...
  return (
    <Container id="swap-page" className="py-4 md:py-8 lg:py-12">
      <Head>
        <title>ContolSwap</title>
        <meta
          key="description"
          name="description"
          content="ContolSwap allows for swapping of ERC20 compatible tokens across Fantom"
        />
      </Head>
      <TokenWarningModal
      ...
      {chainId === ChainId.FANTOM ? (
        <>
          <div className="justify-items-center justify-center object-center text-center">
            <ReactPlaceholder
              type="rect"
              ready={TVL !== 0}
              showLoadingAnimation={true}
              color="#2F0006"
              style={{ width: '250px', height: '50px', borderRadius: '15px', margin: '0 auto' }}
            >
              <h3 className="text-4xl font-semibold object-center text-center" style={{ zIndex: 99999 }}>
                ${TVL}
              </h3>
              <span className="object-center text-center">Total Value Locked</span>
            </ReactPlaceholder>
            <br />
            <br />
          </div>
        ...
        <div className="w-full max-w-xl rounded">
          <img
            ...
            alt=""
          />
          <div className="w-full cursor-pointer pt-4 w-full" onClick={() => toggleNetworkModal()}>
            <DarkCard>
              <div className="flex justify-between items-center overflow-hidden">
                <img src="/wraithcoin.png" className="w-32 h-32 absolute left-2" alt="" />
                <div className="pl-32">
                  <div className="text-high-emphesis">Swap to the Fantom (FTM) Network</div>
                  <div className="text-high-emphesis text-sm">Click here to switch to Fantom using Metamask</div>
                </div>
              </div>
            </DarkCard>
          </div>
