  ...
  return (
    <Modal isOpen={networkModalOpen} onDismiss={toggleNetworkModal} maxWidth={672}>
      ...
      <div className="mb-6 text-lg text-primary">
        You are currently browsing <span className="font-bold text-red">ContolSwap</span>
        <br /> on the <span className="font-bold text-yellow">{NETWORK_LABEL[chainId]}</span> network
      </div>
