...
const useLPTokensState = () => {
  ...
  const dashboardContract = useBoringHelperContract() //useDashboardContract()
          ...
          await Promise.all(
            pages.map((page) =>
              boringHelperContract?.getPairs(
                '0x152eE697f2E276fA89E96742e9bB9aB1F2E61bE3', // SpookySwap Factory address
                page,
